...
import re
import os
# from pyspark.sql import SparkSession # Comentado temporariamente
...
#     .appName("API com PySpark") \
#     .config("spark.driver.extraClassPath", "sqlite-jdbc-3.34.0.jar") \
#     .getOrCreate() # Comentado temporariamente
...
def listar_usuarios():
    """Lista todos os usuários ativos (versão sem PySpark)"""
    try:
...
def buscar_usuarios():
    """Busca usuários por nome ou email (versão sem PySpark)"""
    try:
